  ...
  getAllBooks() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        booksList.add(productModel.fromJson(responseData));

        if (booksList.isEmpty) {
          isLoaded = 3;
        } else {
          isLoaded = 1;
          print('BOOK NUMBER: ${widget.id}');
          print('First Book Name: ${booksList.first.bookName}');
        }
      } else {
        isLoaded = 2;
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: [
            if (isLoaded == 1 && booksList.isNotEmpty)
              Padding(
                padding: const EdgeInsets.only(right: 135),
                child: Text(
                  '${booksList.first.bookName}',
                  style: TextStyle(
                      fontSize: 22,
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: CachedNetworkImage(
                      height: 170,
                      width: 141,
                      imageUrl: booksList.first.bookImagePath!,
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
                  ...
                  children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: booksList.first.isAvailable == true
                              ? Colors.greenAccent
                              : Colors.redAccent,
                        ),
                        child: Center(
                            child: Text(booksList.first.isAvailable == true
                                ? 'In Stock'
                                : 'Sold Out'))),
                    booksList.first.isRentable == true
                        ? Image.network(
            ...
            Padding(
              ...
              child: Text(
                booksList.first.bookPrice.toString() + "\$",
                style: TextStyle(
                    fontSize: 18,
                    fontStyle: FontStyle.normal,
                    fontWeight: FontWeight.w700),
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    '${booksList.first.bookAuthorName}',
                    style: TextStyle(
                        fontSize: 14,
                        color: Colors.grey,
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    '${booksList.first.bookPublisherName}',
                    style: TextStyle(
                        fontSize: 14,
                        color: Colors.grey,
                        fontWeight: FontWeight.w300),
